...
### ⬇️ 다운로드 (Windows v1.0.0)

- **권장 · MSI 설치 (EV 코드 서명)** — [AI_PR_Review_Toolkit_1.0.0_x64_en-US.msi](https://github.com/ssallem/ai-pr-review-app/releases/download/v1.0.0/AI_PR_Review_Toolkit_1.0.0_x64_en-US.msi)
- **대체 · NSIS Setup (EXE)** — [AI_PR_Review_Toolkit_1.0.0_x64-setup.exe](https://github.com/ssallem/ai-pr-review-app/releases/download/v1.0.0/AI_PR_Review_Toolkit_1.0.0_x64-setup.exe)
...
### Windows (v1.0.0 — 정식 출시)

위 [⬇️ 다운로드 (Windows v1.0.0)](#%EF%B8%8F-다운로드-windows-v100) 섹션의 MSI 또는 EXE 중 하나를 받는다.

| 파일 | 용도 | 권장 상황 |
|------|------|----------|
| `AI_PR_Review_Toolkit_1.0.0_x64_en-US.msi` | MSI 설치 관리자 | 일반 사용자 (그룹 정책·MDM 환경 포함) |
| `AI_PR_Review_Toolkit_1.0.0_x64-setup.exe` | NSIS Setup | MSI 차단 환경 또는 개인 PC |
